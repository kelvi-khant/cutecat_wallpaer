...
public class BlackcatActivity extends AppCompatActivity {
    ImageView back;
    private RecyclerView artWallpaperRV;
...
//        getWindow().setStatusBarColor(Color.TRANSPARENT);
        ...
        artWallpaperRV = findViewById (R.id.ARTWallpaperRV);
        lodingPB = findViewById (R.id.progressbar);

        artWallpaperRV.setLayoutManager (new LinearLayoutManager (this));
        getWallpapers ();
    ...
    private void getWallpapers() {
        String Api = "http://ayttechnology.com/catiowp_panel/api/v1/api.php?get_new_wallpapers&page=1&count=44&filter=both&order=recent&category=4";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest (Request.Method.GET, Api, null, new Response.Listener<JSONObject> () {
            ...
            public void onResponse(JSONObject json) {
                ...
                try {
                    ...
                    CatAdepter adapter = new CatAdepter (BlackcatActivity.this, list);
                    artWallpaperRV.setAdapter (adapter);
