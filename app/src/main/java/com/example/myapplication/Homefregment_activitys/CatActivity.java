...
public class CatActivity extends AppCompatActivity {
    ImageView back;
    private RecyclerView catWallpaperRV;
...
//        getWindow().setStatusBarColor(Color.TRANSPARENT);
        ...
        catWallpaperRV =findViewById (R.id.CATWallpaperRV);
        lodingPB =findViewById (R.id.progressbar);
        catWallpaperRV.setLayoutManager (new LinearLayoutManager (this));
        getWallpapers();
    ...
    private void getWallpapers() {
        String Api = "http://ayttechnology.com/catiowp_panel/api/v1/api.php?get_new_wallpapers&page=1&count=63&filter=both&order=recent&category=5";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest (Request.Method.GET, Api, null, new Response.Listener<JSONObject> () {
            ...
            public void onResponse(JSONObject json) {
                ...
                try {
                    ...
                    CatAdepter adapter = new CatAdepter (CatActivity.this, list);
