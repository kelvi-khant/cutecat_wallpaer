...
public class FunnyCatActivity extends AppCompatActivity {
    ImageView back;
    private RecyclerView FunnyWallpaperRV;
...
//        getWindow().setStatusBarColor(Color.TRANSPARENT);
        setContentView (R.layout.activity_funny_cat);
        back = findViewById (R.id.back);
        FunnyWallpaperRV =findViewById (R.id.FunnyWallpaperRV);
        lodingPB =findViewById (R.id.progressbar);
        FunnyWallpaperRV.setLayoutManager (new LinearLayoutManager (this));
        getWallpapers();
    ...
    private void getWallpapers() {
        String Api = "http://ayttechnology.com/catiowp_panel/api/v1/api.php?get_new_wallpapers&page=1&count=42&filter=both&order=recent&category=1";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest (Request.Method.GET, Api, null, new Response.Listener<JSONObject> () {
            ...
            public void onResponse(JSONObject json) {
                ...
                try {
                    ...
                    CatAdepter adapter = new CatAdepter (FunnyCatActivity.this, list);
                    FunnyWallpaperRV.setAdapter (adapter);
