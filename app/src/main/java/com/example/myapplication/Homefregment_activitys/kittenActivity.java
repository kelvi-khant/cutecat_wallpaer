...
public class kittenActivity extends AppCompatActivity {
    ...
    ImageView back;
    private RecyclerView girlWallpaperRV;
...
//        getWindow().setStatusBarColor(Color.TRANSPARENT);
       ...
       girlWallpaperRV =findViewById (R.id.GIRLWallpaperRV);
        lodingPB =findViewById (R.id.progressbar);
        girlWallpaperRV.setLayoutManager (new LinearLayoutManager (this));
        getWallpapers();
    ...
    private void getWallpapers() {
        String Api = "http://ayttechnology.com/catiowp_panel/api/v1/api.php?get_new_wallpapers&page=1&count=33&filter=both&order=recent&category=3";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest (Request.Method.GET, Api, null, new Response.Listener<JSONObject> () {
            ...
            public void onResponse(JSONObject json) {
                ...
                try {
                    ...
                    CatAdepter adapter = new CatAdepter (kittenActivity.this, list);
                    girlWallpaperRV.setAdapter (adapter);
